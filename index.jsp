...
<body>
			...
			<ul class="navbar-nav mr-auto">
				...
				<li class="nav-item dropdown">
					...
					<div class="dropdown-menu" aria-labelledby="dropdown">
						...
						<a class="dropdown-item" href="userLogot.jsp">로그아웃</a>
					</div>
				</li>
			</ul>
	...
	<section class="container">
		...
		<div class="card bg-light mt-3">
			<div class="card-header bg-light">
				<div class="row">
					<div class="col-8 text-left">컴퓨터개론&nbsp;<small></small></div>
			...
			<div class="card-body">
				<h5 class="card-title">
				정말 좋은 강의네요.&nbsp;<small>(2020년 여름학기)</small>
				</h5>
				<p class = "card-text">강의가 널널</p>
				<div class="row">
		...
		<div class="card bg-light mt-3">
			<div class="card-header bg-light">
				<div class="row">
					<div class="col-8 text-left">컴퓨터그래픽스&nbsp;<small></small></div>
					<div class="col-4 text-right">
			...
			<div class="card-body">
				<h5 class="card-title">
				별로에요.&nbsp;<small>(2020년 가을학기)</small>
				</h5>
				<p class = "card-text">강의가 빡셈</p>
				<div class="row">
					<div class ="col-9 text-left">
					...
					<form action="./evaluationRegisterAction.jsp" method="post">
						<div class="form-row">
							...
							<div class="modal-footer">
								...
								<button type="submit" class="btn primary" data-dismiss="modal">등록하기</button>
							</div>
						</form>
				</div>
			</div>
	...
	<footer class="bg-dark mt-4 p-5 text-center" style="color: #FFFFFF">
		Copyright &copy; 2020 나나나 All Right Reserved.
	</footer>
	<!-- 제이쿼리 자바스크립트 추가하기 -->
